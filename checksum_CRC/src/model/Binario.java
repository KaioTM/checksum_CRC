...
public class Binario {
    ...
    // Método responsável 
    public String criaBinarioPolinomioGerador(int polinomioGeradorDigitadoHexa) {
        return String.format("%09d", Integer.parseInt(Integer.toBinaryString(polinomioGeradorDigitadoHexa)), 2);
    }
